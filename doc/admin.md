...
- You need to modify the function "run<sub>preprocess</sub>" in the
...
Other permissions are not transferred from parents to
children and access is not transferred from a child to a parent.
...
You can select manual, inside detailed view of each group and sub-group,
