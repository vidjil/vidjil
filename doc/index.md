...
**[Vidjil](https://www.vidjil.org) is an open-source platform for the analysis of high-throughput
sequencing data from lymphocytes.** [V(D)J recombinations](https://en.wikipedia.org/wiki/V\(D\)J_recombination) in lymphocytes are
...
- Tutorial "Mastering the Vidjil web application":
  [english](https://www.vidjil.org/doc/tutorial/mastering-vidjil.html)
  ([pdf](https://www.vidjil.org/doc/tutorial/mastering-vidjil.pdf))
  <!-- [français](https://www.vidjil.org/doc/tutorial/mastering-vidjil-fr.html)
  ([pdf](https://www.vidjil.org/doc/tutorial/mastering-vidjil-fr.pdf))  -->
  🔗.
...
- [Demo access](https://app.vidjil.org/) 🔗 to the patient, experiment and sample public test server
...
- Specification of the [warnings](warnings.md), list of [default tags](tags.md)
...
- [Public datasets](https://www.vidjil.org/data/) 🔗 supporting Vidjil publications
...
are available from the [doc/](https://gitlab.inria.fr/vidjil/vidjil/-/tree/dev/doc) directory in the source files.
