...
séléectionnez le patient \textit{Demo LIL-L3} patient, et cliquez sur le lien en bas à droite
``see results: multi''.
L'application web Vidjil s'ouvre.
}
\section{Évaluation de la qualité d'un run et de l'analyse}

\question{Connect to the public server (\url{https://app.vidjil.org}), either with your account or the demo account,
Chargez les fichiers (Demo LIL-L3)}
