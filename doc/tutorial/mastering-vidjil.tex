...
\question{Try also the options  \com{alleleles in clone names} : by selecting \com{always}, the clone
...
\marginpar{When loading data with only one samples, the time graph is replaced by a second bar/grid plot.}
...
\section{Working with external software or data}
