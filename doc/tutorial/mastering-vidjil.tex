...
common ways to visualize, filter, analyze and cluster clones
...
You can directly go to the part of the tutorial you are more interested in.
Bear in mind
that the first part of the tutorial uses a dataset that is
provided at the start
while the other parts use a toy dataset
