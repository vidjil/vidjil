...
reads differ from the previous point. We can again analyze the reason why some
reads were unsegmented.

\question{Hover labels of the time graph. What do you see? }
...
\begin{verbatim}
  ...
  // test_C_samples_09_compare_sample
    ...
    cy.get('#visu_id_label_y_1e-7').should("exist").should("be.visible", "correct legend for axe Y at pos 7 (smallest)")
