...
\begin{verbatim}
  cy.log("// test_008_upload_new_samples_in_run")
    var path = "../../../../../../tutorial/"
    cy.addSample(undefined, "computer", "tutorial/run1-sample1.fasta", undefined, "2010-01-01", "Sample 1 from tutorial server test #functional #tutorial")
    cy.addSample(undefined, "computer", "tutorial/run1-sample2.fasta", undefined, "2010-01-01", "Sample 2 from tutorial server test #functional #tutorial")
    cy.addSample(undefined, "computer", "tutorial/run1-sample3.fasta", undefined, "2010-01-01", "Sample 3 from tutorial server test #functional #tutorial")
...
\begin{verbatim}
  ...
  cy.log("// test_009_upload_sample_set_common_sets")
    ...
    // cy.get('tr').contains("Last_name_1 ")
    // cy.get('tr').contains("Last_name_2 ")
    // cy.get('tr').contains("Last_name_3 ")
