...
window.onresize = initCoef;
  ...
  var msg= {
    ...
    "file_error" : "ERROR : incorrect data file"
    +"</br> please check you use a correct json data file generated by vidjil:command or vidjil:fuse"
    +"</br></br> <div class='center' > <button onclick='closePopupMsg()'>ok</button></div>",
    
    "version_error" : "ERROR : incorrect data file"
    +"</br> "
    +"</br></br> <div class='center' > <button onclick='closePopupMsg()'>ok</button></div>",
