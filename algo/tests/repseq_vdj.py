...
VIDJIL_KMER = '{directory}/vidjil-algo -w 20 --header-sep "|" -b out -c windows -uuuU -1 -2 -g {directory}/germline/homo-sapiens.g %s > /dev/null ; cat out/out.detected.vdj.fa out/out.undetected.vdj.fa >> %s'
