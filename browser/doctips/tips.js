...
tips = {
    ...
    'I30': 'The search bar (above the list) filters clones on their DNA sequence, gene names, or CDR3 partial aa sequence. See <a href="https://www.vidjil.org/doc/user/#the-info-panel-upper-left-panel">here</a>',
    ...
    'S10': 'Different run configs are designed to analyze different types of data. Find out more <a href="https://www.vidjil.org/doc/user/#processing-samples-and-process-configurations">here</a>.',
    ...
    'S20': 'By saving your analysis all your changes are stored (clone colors, sample reorganization, clusters, sample information). Just press <span class="key">Ctrl+s</span>, or click « save » in the menu over the patient name.',
    ...
    'T30': '<span class="key">←</span> and <span class="key">→</span> navigate between samples. Discover other <a href="https://www.vidjil.org/doc/user/#keyboard-shortcuts">keyboard shortcuts</a>.',
    'T31': '<span class="key">+</span> clusters the selected clones, and <span class="key">Backspace</span> reverts to the previous clustering. Discover other <a href="https://www.vidjil.org/doc/user/#keyboard-shortcuts">keyboard shortcuts</a>.',
    'T32': '<span class="key">H</span>  switches the display to IGH clones, <span class="key">B</span>  to TRB clones, and so on. Discover other <a href="https://www.vidjil.org/doc/user/#keyboard-shortcuts">keyboard shortcuts</a>.',
    ...
    'O10': 'Vidjil is very flexible, the limits set on the servers may not apply to a local usage. See the  <a href="https://www.vidjil.org/doc/vidjil-algo/">documentation of the command-line algorithm</a>.',
    'O11': 'The built-in Vidjil algorithm can be downloaded and installed on any Linux computer. See <a href="https://www.vidjil.org/doc/vidjil-algo/>its documentation and install instructions</a>.',
    ...
    'B02': 'Have you ever seen a rainbow Genescan? Select the plot preset <span class="key">4</span> and change the color mode to "clones". Each clone is coloured randomly.',
    'B03': 'Clones with very low average coverage will display a warning sign instead of the "info" button. If you wonder what this means, have a look at <a href="https://www.vidjil.org/doc/user/#clonotype-coverage">our documentation</a>.',
    'B04': 'Clones with large e-values will display a warning sign instead of the "info" button. If you wonder what this means, have a look at <a href="https://www.vidjil.org/doc/user/#e-value">our documentation</a>.',
    ...
    'B07': 'Do you have a "xxx" locus appearing in your result? This one just gathers totally unexpected recombinations (between distinct chains, or on different strands), such as PCR dimers. See <a href="https://www.vidjil.org/doc/libraries-recombinations/">here</a>.',
