...
function ScatterPlot(id, model, database, default_preset) {
    ...
    */
    ...
    this.preset = {
        ...
        "clone average reads length / locus" : { "mode": this.MODE_GRID, "x": "averageLength", "y" : "locus"},
        // "V/abundance" : { "mode": this.MODE_GRID, "x" : this.AXIS_GENE_V, "y": "size"},
        "clone average reads length distribution" : { "mode": this.MODE_BAR, "x" : "averageLength", "y": "size"},
        ...
        "clone average reads length / GC content " : { "mode": this.MODE_GRID, "x": "averageLength", "y" : "GCContent"},
