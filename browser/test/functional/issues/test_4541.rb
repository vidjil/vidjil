...
class TestGraph < BrowserTest
 ...
 def setup
    super
    if not defined? $b
      # set_browser("/browser/test/data/issues/issues_4541/4541.vidjil")
    end
  end
  ...
  def test_00_load_analysis_simple_reorder
    set_browser("/browser/test/data/issues/issues_4541/4541.vidjil", "/browser/test/data/issues/issues_4541/4541_00_stock.analysis")
  ...
  def test_01_load_analysis_hidden_sample
    set_browser("/browser/test/data/issues/issues_4541/4541.vidjil", "/browser/test/data/issues/issues_4541/4541_01.analysis")
    assert ( $b.span(:id => "visu2_title").text == "2 / 3" ), "Ratio show is correct at init"
    assert (    $b.graph_x_legend('0').text == 'file0_name')
    assert (not $b.graph_x_legend('1').present?)
    assert (    $b.graph_x_legend('2').text == 'file2_name')
  ...
  def test_02_load_analysis_one_more_sample
    set_browser("/browser/test/data/issues/issues_4541/4541_02.vidjil", "/browser/test/data/issues/issues_4541/4541_01.analysis")
  ...
  def test_03_load_analysis_deleted_sample
    set_browser("/browser/test/data/issues/issues_4541/4541_03_deleted_sample.vidjil", "/browser/test/data/issues/issues_4541/4541_00_stock.analysis")
  ...
  def test_04_load_analysis_all_new_samples
    set_browser("/browser/test/data/issues/issues_4541/4541.vidjil", "/browser/test/data/issues/issues_4541/4541_04_all_new_samples.analysis")
  ...
  def test_05_load_analysis_duplicate_in_order
    set_browser("/browser/test/data/issues/issues_4541/4541.vidjil", "/browser/test/data/issues/issues_4541/4541_05_duplicate_in_order.analysis")
    assert ( $b.span(:id => "visu2_title").text == "2 / 3" ), "Ratio show is correct at init"
    assert (    $b.graph_x_legend('0').text == 'file0_name')
    assert (not $b.graph_x_legend('1').present?)
    assert (    $b.graph_x_legend('2').text == 'file2_name')
