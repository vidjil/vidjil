...
if  __name__ =='__main__':
    ...
    vidjil.login("user.email@society.com", "password")
    ...
    ### Example 1; creating a set, upload data and launch analysis
    ...
    for sample in samples["query"]:
        if sample["results_file"]["status"] == "COMPLETED":
            ...
            filename = path_out+"set%s_sequence%s_config%s.vidjil" % (sampleset["sample_set_id"], sample["sample_set_membership"]["sequence_file_id"], config_id)  
