...
var config = {
    ...
    */
     ...
     */
    "cgi_address" : "https://localhost:8000/cgi/", // Public test server
    // "cgi_address" : "http://127.0.1.1/cgi-bin/",

    /* Proxy for accessing resources without cross-domain issues */
    "proxy": "https://localhost:8000/vidjil/proxy/",
    ...
    "server_id" : "",
    "use_database" : true,
    "db_address" : "https://131.254.23.55:8000/vidjil/", // Public test server
    "login" : "",
    "password" : "",
