...
var config = {
  ...
  hosting:
    "⚠️ Research Use Only. This instance of Vidjil is hosted by Xxxxxxxx Xxxxxxxxx. This instance is not compliant for clinical use and comes with no warranty. See options for using Vidjil while <a href='http://www.vidjil.org/doc/healthcare'>hosting healthcare data</a>.",
  ...
  /* Display an alert in the header */
  // "alert": "Rescue server",
   ...
   */
  cgi_address: "https://localhost/cgi/",
  ...
  /* 1) Patient database */
  use_database: true,
  db_address: "https://localhost/vidjil/",
