...
### Personalization
WELCOME_LOGINPAGE_MESSAGE = os.getenv("WELCOME_LOGINPAGE_MESSAGE", default="Welcome to a Vidjil server!")

SERVER_URL = os.getenv("SERVER_URL", default="app.vidjil.org") # Use conf.js value ?
