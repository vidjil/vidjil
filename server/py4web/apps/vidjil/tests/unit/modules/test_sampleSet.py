    ...
    def test_show_results_fields(self):
        ...
        data_results = {
            ...
            "_extra": {
                ...
                "GROUP_CONCAT(DISTINCT config.id, ';', config.name, ';', fused_file.fused_file)": "2;multi+inc+xxx;fused_file.fused_file.bc7f86d336e8c296.MDAwMDA3LTIuZnVzZWQ=.fused,3;multi+inc;fused_file.fused_file.b8e8ae213c894f15.MDAwMDExLTIuZnVzZWQ=.fused",
