...
class SampleSetList:
    ...
    def __init__(
        self, helper, page=None, step=None, tags=None, search=None, setid=None
    ):
        ...
        left = [
            db.sample_set_membership.on(
                s_table.sample_set_id == db.sample_set_membership.sample_set_id
            ),
            db.sequence_file.on(
        ...
        group_configs = sampleSet.get_conf_list_select()
        group_config_ids = sampleSet.get_config_ids_select()
        group_config_names = sampleSet.get_config_names_select()
        group_group_names = sampleSet.get_group_names_select()
        group_file_sizes = sampleSet.get_file_sizes_select()
