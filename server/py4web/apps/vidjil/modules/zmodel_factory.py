...
class Patient(SampleSet):
    ...
    def get_fields(self):
        ...
        fields.insert(1, {'name': 'birth', 'sort': 'birth', 'call': self.get_birth, 'sort_call': self.get_birth, 'width': 100, 'public': True})
        return fields
...
class Run(SampleSet):
    ...
    def get_fields(self):
        ...
        fields.insert(1, {'name': 'run_date', 'sort': 'run_date', 'call': self.get_run_date, 'sort_call': self.get_run_date, 'width': 100, 'public': True})
        return fields
